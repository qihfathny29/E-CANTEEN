        ...
        <form action="{{ route('admin.menus.update', $menu) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="kategori" id="kategori-select" class="form-select">
                    ...
                    <option value="makanan_utama" {{ old('kategori', $menu->kategori) === 'makanan_utama' ? 'selected' : '' }}>Makanan Utama</option>
                    ...
                    <option value="spesial_promo" {{ old('kategori', $menu->kategori) === 'spesial_promo' ? 'selected' : '' }}>Spesial Promo</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="toggle-group">
                    <label class="toggle-switch">
                        <input type="checkbox" name="is_pedas" id="is-pedas-input" value="1" {{ old('is_pedas', $menu->is_pedas) ? 'checked' : '' }}>
